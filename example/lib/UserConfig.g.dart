...
class _UserConfigHiveImpl implements UserConfigHive {
  /// 配置代理实例，静态成员保证全局唯一
  static final HiveConfigStorageImpl _ConfigProxy = HiveConfigStorageImpl();
  ...
  Future<void> init() async {
    await _ConfigProxy.init("UserConfigHive");
    _read();
  }
  ...
  /// 单例实例
  static final UserConfigHive _instance = _UserConfigHiveImpl();
}

/// 获取单例实例的方法
UserConfigHive _$GetUserConfigHive() => _UserConfigHiveImpl._instance;

/// 扩展方法，用于初始化配置
extension UserConfigHiveExtension on UserConfigHive {
  Future<void> initUserConfigHive() async {
    await (this as _UserConfigHiveImpl).init();
  }
}

class _UserConfigMMKVImpl implements UserConfigMMKV {
  /// 配置代理实例，静态成员保证全局唯一
  static final MMKVConfigStorageImpl _ConfigProxy = MMKVConfigStorageImpl();
  ...
  /// 初始化配置
  Future<void> init() async {
    await _ConfigProxy.init("UserConfigMMKV");
    _read();
  }
  ...
  /// 单例实例
  static final UserConfigMMKV _instance = _UserConfigMMKVImpl();
}

/// 获取单例实例的方法
UserConfigMMKV _$GetUserConfigMMKV() => _UserConfigMMKVImpl._instance;

/// 扩展方法，用于初始化配置
extension UserConfigMMKVExtension on UserConfigMMKV {
  Future<void> initUserConfigMMKV() async {
    await (this as _UserConfigMMKVImpl).init();
  }
}
